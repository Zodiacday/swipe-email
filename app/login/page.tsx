            ...
            >
                ...
                <div className="bg-zinc-950 p-8 rounded-[40px] border border-zinc-900 shadow-2xl">
                    <MagneticButton
                        ...
                        className="w-full py-4 bg-white text-zinc-950 font-black tracking-widest uppercase text-xs rounded-2xl flex items-center justify-center gap-3 mb-4 shadow-xl hover:bg-zinc-200 transition-colors"
                    >
